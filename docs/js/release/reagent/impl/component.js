...
if((i < len)){
var k = (ks[i]);
var G__25997 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__25998 = (i + (1));
m = G__25997;
i = G__25998;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__25999 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__25999) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__25999));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26001 = c;
var G__26001__$1 = (((G__26001 == null))?null:G__26001.prototype);
if((G__26001__$1 == null)){
return null;
} else {
return (G__26001__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26003 = c;
var G__26003__$1 = (((G__26003 == null))?null:G__26003.prototype);
if((G__26003__$1 == null)){
return null;
} else {
return (G__26003__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__26007__delegate = function (args){
var G__26005 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26005) : reagent.impl.component.as_element.call(null,G__26005));
};
var G__26007 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__26008__i = 0, G__26008__a = new Array(arguments.length -  0);
while (G__26008__i < G__26008__a.length) {G__26008__a[G__26008__i] = arguments[G__26008__i + 0]; ++G__26008__i;}
  args = new cljs.core.IndexedSeq(G__26008__a,0,null);
} 
return G__26007__delegate.call(this,args);};
G__26007.cljs$lang$maxFixedArity = 0;
G__26007.cljs$lang$applyTo = (function (arglist__26009){
var args = cljs.core.seq(arglist__26009);
return G__26007__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__26011 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26012 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26012;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26011;
}});
...
var G__26013 = key;
var G__26013__$1 = (((G__26013 instanceof cljs.core.Keyword))?G__26013.fqn:null);
switch (G__26013__$1) {
...
return ((function (G__26013,G__26013__$1){
...
var c = this;
var G__26018_26020 = (c["cljsRatom"]);
if((G__26018_26020 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26018_26020);
}
...
var renders_26022 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_26023 = cljs.core.first(cljs.core.vals(renders_26022));
if((cljs.core.count(renders_26022) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26022))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26023)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26023], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__26021 = name;
switch (G__26021) {
case "":
...
var G__26026 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__26026) : reagent.impl.component.global$module$create_react_class.call(null,G__26026));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__26027 = fiber;
var G__26027__$1 = (((G__26027 == null))?null:(G__26027["type"]));
if((G__26027__$1 == null)){
return null;
} else {
return (G__26027__$1["displayName"]);
}
})();
var parent = (function (){var G__26028 = fiber;
if((G__26028 == null)){
return null;
} else {
return (G__26028["return"]);
}
})();
var path = (function (){var G__26029 = parent;
var G__26029__$1 = (((G__26029 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__26029) : reagent.impl.component.fiber_component_path.call(null,G__26029)));
if((G__26029__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26029__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = (function (){var G__26031 = c;
if((G__26031 == null)){
return null;
} else {
return (G__26031["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__26032._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__26034 = c;
if((G__26034 == null)){
return null;
} else {
return (G__26034["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__26036 = c;
if((G__26036 == null)){
return null;
} else {
return G__26036._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__26038 = instance;
if((G__26038 == null)){
return null;
} else {
return (G__26038["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__26039 = instance;
if((G__26039 == null)){
return null;
} else {
return G__26039._currentElement;
}
}
})();
var name = (function (){var G__26040 = elem;
var G__26040__$1 = (((G__26040 == null))?null:(G__26040["type"]));
if((G__26040__$1 == null)){
return null;
} else {
return (G__26040__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__26042 = elem;
if((G__26042 == null)){
return null;
} else {
return (G__26042["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__26043._owner;
}
}
})();
var path = (function (){var G__26044 = owner;
var G__26044__$1 = (((G__26044 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__26044) : reagent.impl.component.component_path.call(null,G__26044)));
if((G__26044__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26044__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__26045 = c;
var G__26045__$1 = (((G__26045 == null))?null:G__26045.constructor);
if((G__26045__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__26045__$1);
}
}
})();
