...
var G__26048 = o;
(G__26048[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26050__i < G__26050__a.length) {G__26050__a[G__26050__i] = arguments[G__26050__i + 0]; ++G__26050__i;}
  args = new cljs.core.IndexedSeq(G__26050__a,0,null);
} 
...
var G__26052 = o;
(G__26052[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26053__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__26053 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__26054__i < G__26054__a.length) {G__26054__a[G__26054__i] = arguments[G__26054__i + 0]; ++G__26054__i;}
  args = new cljs.core.IndexedSeq(G__26054__a,0,null);
} 
return G__26053__delegate.call(this,args);};
G__26053.cljs$lang$maxFixedArity = 0;
G__26053.cljs$lang$applyTo = (function (arglist__26055){
var args = cljs.core.seq(arglist__26055);
return G__26053__delegate(args);
});
G__26053.cljs$core$IFn$_invoke$arity$variadic = G__26053__delegate;
return G__26053;
})()
;
} else {
...
var G__26057 = props;
var G__26057__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26057,cljs.core.cst$kw$id,id):G__26057);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26057__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26058){
var map__26059 = p__26058;
var map__26059__$1 = (((((!((map__26059 == null))))?(((((map__26059.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26059.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26059):map__26059);
var props = map__26059__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26059__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26059,map__26059__$1,props,class$){
return (function (c){
...
});})(map__26059,map__26059__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26061){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26062__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26062,map__26062__$1,on_write){
return (function (){
...
});})(node_value,map__26062,map__26062__$1,on_write))
);
} else {
...
var G__26065 = jsprops;
(G__26065["defaultValue"] = value);

(G__26065["onChange"] = ((function (G__26065,v,value,on_change){
return (function (p1__26064_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26064_SHARP_);
});})(G__26065,v,value,on_change))
);
...
var vec__26068 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26068,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26068,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26068,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26072 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26072 == null)){
} else {
var key_26073 = temp__5724__auto___26072;
(jsprops["key"] = key_26073);
}
...
var temp__5724__auto___26074 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26074 == null)){
} else {
var key_26075 = temp__5724__auto___26074;
reagent.impl.template.oset(jsprops,"key",key_26075);
}
...
var G__26076 = reagent.impl.template.__GT_NativeWrapper();
(G__26076["name"] = c);
...
var G__26077 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26077) : reagent.impl.template.as_element.call(null,G__26077));
} else {
...
var len__4641__auto___26082 = arguments.length;
var i__4642__auto___26083 = (0);
while(true){
if((i__4642__auto___26083 < len__4641__auto___26082)){
args__4647__auto__.push((arguments[i__4642__auto___26083]));

var G__26084 = (i__4642__auto___26083 + (1));
i__4642__auto___26083 = G__26084;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26080){
var G__26081 = cljs.core.first(seq26080);
var seq26080__$1 = cljs.core.next(seq26080);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26081,seq26080__$1);
});
...
break;
default:
var G__26087 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26087;
continue;
...
var n__4518__auto___26089 = a.length;
var i_26090 = (0);
while(true){
if((i_26090 < n__4518__auto___26089)){
(a[i_26090] = reagent.impl.template.as_element((a[i_26090])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___26092 = a.length;
var i_26093 = (0);
while(true){
if((i_26093 < n__4518__auto___26092)){
var val_26094 = (a[i_26093]);
if(((cljs.core.vector_QMARK_(val_26094)) && ((reagent.impl.template.key_from_vec(val_26094) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26093] = reagent.impl.template.as_element(val_26094));

var G__26095 = (i_26093 + (1));
i_26093 = G__26095;
continue;
} else {
}
...
var ctx = ({});
var vec__26096 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26096,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26096,(1),null);
...
var G__26099 = (cljs.core.count(argv) - first_child);
switch (G__26099) {
case (0):
...
case (1):
var G__26100 = comp;
var G__26101 = jsprops;
var G__26102 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26100,G__26101,G__26102) : reagent.impl.template.global$module$react.createElement.call(null,G__26100,G__26101,G__26102));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26099){
